...
public class POSFragment extends Fragment {
    ...
    public POSFragment(ArrayList<Product> collection){
        super();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_p_o_s, container, false);

        addProduct = rootView.findViewById(R.id.cart_button);
        ...
        addProduct.setOnClickListener(e -> {
            if(getActivity() instanceof MainActivity){
                ((MainActivity) getActivity()).startSale();
            }
        });
